    ...
    <div className="h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
      ...
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8">
          {/* This is the pickup location dropdown */}
          <div className="flex flex-col md:flex-col items-start gap-2">
            <select
              required
          ...
          {/* This is the pickup date input field */}
          <div className="flex flex-col md:flex-col items-start gap-2">
          ...
          {/* This is the return date input field */}

          {/* yha mujhe change krna hai ki return date pickup date s hi start ho */}
          <div className="flex flex-col md:flex-col items-start gap-2">
